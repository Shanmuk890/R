...
# Copy your R script (your_api_file.R) into the container
...
CMD R -e "library(plumber); pr <- plumb('/usr/src/app/your_api_file.R'); pr %>% swagger(); pr$run(host='0.0.0.0', port=8000)"
